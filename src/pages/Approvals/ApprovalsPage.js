...
export function ApprovalsPage() {
  ...
  return `
    <main class="page-content approvals-page">
      <div class="approvals-page__heading"><div><p class="eyebrow">Tourism office</p><h1>Booking approvals.</h1><p class="page-content__intro">Review incoming requests before they enter the tour guide management queue.</p></div>${StatusBadge({ label: `${pending.length} pending`, tone: pending.length ? 'warning' : 'success' })}</div>
