...
export function TrackingPage() {
  ...
  return `
    <main class="page-content tracking-page">
      ...
      <section class="tracking-map-panel"><div id="tracking-map" class="tracking-map" aria-label="Interactive map of the Alto Peak trek route"></div><div class="tracking-map-panel__legend"><span><i class="legend-dot legend-dot--tourist"></i>Tourist</span><span><i class="legend-dot legend-dot--guide"></i>Guide</span><span><i class="legend-dot legend-dot--summit"></i>Summit</span></div></section>
      <div class="tracking-stats"><article><span>Trail progress</span><strong>${progress}%</strong><small>${location.label}</small></article><article><span>Distance covered</span><strong>${location.distance}</strong><small>of 4.8 km route</small></article><article><span>Estimated arrival</span><strong>${location.eta}</strong><small>${completed ? 'At the summit' : 'to Alto Peak summit'}</small></article></div>
